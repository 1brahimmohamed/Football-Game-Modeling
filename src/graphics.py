...
def draw_screen(WIN, ball, current_mouse_position, slider_pos):
    ...
    slider_bar = pygame.Rect(configurations.slider_position,
    ...
    slider_value = configurations.font.render(str(int(calc_slider_value(slider_pos))), True, colors.WHITE)
